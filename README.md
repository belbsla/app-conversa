...
Crie um repositório novo no GitHub e mande esses arquivos pra lá, mantendo a pasta api/.
Entre em vercel.com, faça login com o GitHub e clique em Add New → Project.
Escolha o repositório. Não precisa mudar nenhuma configuração — a Vercel reconhece sozinha.
